...
biomechanics beyond the saturating force/activation model used here, or
other aspects of longer-term structural plasticity. An optional
activity-dependent fatigue term is available and is used in the closed-loop
force-triggered extension (\autoref{sec:methods:forcetrigger},
\autoref{sec:results:forcetrigger}), but is off by default and not active in
the externally clocked paced-gait results reported above.
