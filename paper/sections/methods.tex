...
length dynamics;
(iv) closed-loop, force-triggered stance termination: each leg's stance
(and its cutaneous paw-contact input) ends when that leg's own extensor
force falls, rather than on a clock, with sequential Ia activation
