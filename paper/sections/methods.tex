...
diagnostic points (the ten 20 20 12 61 79 80 81 701 33 98 100 204 250 395 398 399 400\mu,\mathrm{CV}) points) spanning four orders of
...
Algorithms~\ref{alg:main}--\ref{alg:speed_stdp} give the pseudocode.
...
the ten 20 20 12 61 79 80 81 701 33 98 100 204 250 395 398 399 400\mu,\mathrm{CV}) points. Used in Section~\ref{sec:results:weights} and
Section~\ref{sec:results:weights}.
...
\begin{algorithmic}[1]
\Require Ten $(\mu_i,\mathrm{CV}_i)$ pairs from the ten 20 20 12 61 79 80 81 701 33 98 100 204 250 395 398 399 400\mu,\mathrm{CV}) points; base seed $S_0=12345$
